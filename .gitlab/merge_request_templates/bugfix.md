...
Explain the bug causes as understood during debugging:

  - what went wrong?
  - how has it been identified: logs, debugging tools, code instrumentation (you can attach patches),... ?
  - impact assessment: related areas of the code that can be affected too.

## Implemented solution

Description of the implementation steps and how it solves the issue:
...
Please, expain how your fix has been validated.
